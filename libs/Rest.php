<?php
    ...
    */
    ...
    class REST
    {
        /* $contentType store responseType  */
        ...
        * $data is mergeed with $requestParams to make it
        * one complete array
        */
        ...
        */
        ...
        /*
        * All the status code and their corresponding status name
        */
        ...
        /*
        * Function to handle request and data
        */
        ...
        /*
        * Function to convert array into json format
        */
        ...
        /*
        * Merge Data into requestParams and check,
        * if every field is set or not
        */
